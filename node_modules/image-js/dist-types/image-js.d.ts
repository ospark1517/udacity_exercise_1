 ...
 */
export declare function getHarrisScore(image: Image_2, origin: Point, options?: GetHarrisScoreOptions): number;
 ...
 */
export declare function getShiTomasiScore(image: Image_2, origin: Point, options?: GetShiTomasiScoreOptions): number;

export declare interface GetShiTomasiScoreOptions {
    qualityLevel?: number;
    /**
     * Size of the window to compute the Harris score.
     * Should be an odd number so that the window can be centered on the corner.
...
export declare type ResolutionUnit = 'inch' | 'centimeter' | 'meter' | 'unknown';
